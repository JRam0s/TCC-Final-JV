...
<head>
    ...
    <title>FinanceWize - Gerenciador de Finanças</title>
    ...
    .form-check-input:not(:disabled):not(.disabled):active:focus {
        ...
        outline: 0;
        border: 0;
        box-shadow: 0 0 0 0.1rem blue !important;
    }
    ...
    .sidebar {
        ...
        z-index: 1000; /* Sidebar acima do conteúdo */
        padding-top: 20px;
    }
    ...
    .container {
        padding-top: 20px;  /* Garante que o conteúdo não fique oculto no topo */
        padding-right: 160px;  /* Espaço suficiente para a sidebar */
        z-index: 1;  /* Conteúdo abaixo da sidebar */
    }
...
.sidebar a:hover {
    background-color: #0056b3;
    color: #ffffff;
    border: 2px solid #0056b3; /* Também mantém a borda azul no hover */
}
...
<body>
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-blue">
        <div class="container-fluid">
            <a href="{{route('index')}}" class="navbar-brand">
                <!--<img src="{{asset('img/natureza.png')}}" width="64" height="64">-->
                <span class="ms-3 fs-5 fw-bold">FinanceWize</span>
            </a>
            <button class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#itens">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#0056b3"
            ...
            <div class="sidebar">
                <h3>Menu</h3>
                <a href="{{ route('ganho.index') }}" class="{{ request()->routeIs('ganho.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3"
                ...
                <a href="{{ route('gasto.index') }}" class="{{ request()->routeIs('gasto.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3"
                ...
                <a href="{{ route('categoria.index') }}"
                    class="{{ request()->routeIs('categoria.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3" class="bi bi-box-fill"
                        viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                ...
                <a href="{{ route('pagamento.index') }}"
                    class="{{ request()->routeIs('pagamento.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3" class="bi bi-box-fill"
                        viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                ...
                <a href="{{ route('meta.index') }}" class="{{ request()->routeIs('meta.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3" class="bi bi-box-fill"
                        viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                ...
                <a href="{{ route('pdf') }}" class="{{ request()->routeIs('pdf') ? 'active' : '' }}" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3" class="bi bi-box-fill"
                        viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                ...
                <a href="{{ route('pizza') }}" class="{{ request()->routeIs('pizza') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#0056b3" class="bi bi-box-fill"
                        viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                ...
                <a href="{{ route('pizzafp') }}" class="{{ request()->routeIs('pizzafp') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="#0056b3" class="bi bi-box-fill"
                        viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                    </svg>
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-2">
                @if($menu == "admin")
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#0056b3" class="bi bi-gear-fill"
                    viewBox="0 0 16 16">
                    <path
            ...
            <div class="col-8 d-flex justify-content-center">
                <span class="text-primary fs-4 fw-bold">{{ mb_strtoupper($submenu, 'UTF-8'); }}</span>
            </div>
            <div class="col-2 d-flex justify-content-end">
                @if(isset($rota))
                <a href="{{ route($rota) }}" class="btn btn-primary ms-2">
...
function showRemoveModal(id, nome) {
    ...
    $('#removeModal').modal().find('.modal-body').append("Deseja remover o registro <b class='text-danger'>'" + nome +
        "'</b> ?");
