@extends('template.main', ['menu' => "admin", 'submenu' => "Nova Categoria"])

@section('titulo') Desenvolvimento Web @endsection

@section('conteudo')

<form action="{{ route('categoria.store') }}" method="POST" enctype="multipart/form-data" class="form-custom">
    @csrf  
    <div class="row">
        <div class="col">
    ...
    <div class="row justify-content-center">
        <div class="col-auto">
            <a href="{{route('categoria.index')}}" class="btn btn-light btn-block align-content-center btn-custom">
